...
<div id="container" class="single page widecolumn clearfix about">
	<div id="content" role="main">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="slide-table">
				...
				<th>商号</th>
				<td><?php echo get_option('profile_corporate_name'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>代表取締役</th>
				<td><?php echo get_option('profile_president'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>所在地/住所</th>
				<td><?php if (get_option('profile_postcode')) : ?><span>〒<?php echo get_option('profile_postcode'); ?>&nbsp;</span><?php endif; ?><?php echo get_option('profile_address'); ?>
				...
				<th>FAX番号</th>
				<td><?php echo get_option('profile_fax'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>営業所</th>
				<td><?php echo wpautop(get_option('profile_branch')); ?>
				</td>
				</tr>
				...
				<th>関連会社</th>
				<td><?php echo wpautop(get_option('profile_group')); ?>
				</td>
				</tr>
				...
				<th>業種</th>
				<td><?php echo wpautop(get_option('profile_industry')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>業務内容</th>
				<td><?php echo wpautop(get_option('profile_business_content')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>従業員数</th>
				<td><?php echo wpautop(get_option('profile_employeenumber')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>資格</th>
				<td><?php echo wpautop(get_option('profile_qualifications')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>免許番号</th>
				<td><?php echo wpautop(get_option('profile_licentiate')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>創立年月日</th>
				<td><?php echo get_option('profile_foundation_date'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>設立年月日</th>
				<td><?php echo get_option('profile_establishment_date'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>資本金</th>
				<td><?php echo get_option('profile_capital_amount'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>写真</th>
				<td><?php echo get_option('profile_photo'); ?>
				</td>
				</tr>
				<?php endif; ?>
				<?php if (get_option('profile_cooperative')) : ?>
				<tr class="profile_cooperative">
				<th>協力会社</th>
				<td><?php echo wpautop(get_option('profile_cooperative')); ?>
				</td>
				</tr>
				...
				<th>技術導入</th>
				<td><?php echo wpautop(get_option('profile_technic')); ?>
				</td>
				</tr>
				...
				<th>瑕疵保証</th>
				<td><?php echo wpautop(get_option('profile_warranty')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>所属団体</th>
				<td><?php echo wpautop(get_option('profile_organization')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>保証協会/保険協会</th>
				<td><?php echo get_option('profile_guaranty_society'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>主要取引先</th>
				<td><?php echo wpautop(get_option('profile_main_client')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>主要取引銀行</th>
				<td><?php echo wpautop(get_option('profile_bank_of_account')); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>営業時間</th>
				<td><?php echo get_option('profile_opening_hours'); ?>
				</td>
				</tr>
				<?php endif; ?>
				...
				<th>定休日</th>
				<td><?php echo get_option('profile_holiday'); ?>
					<?php echo ('<br>'), (get_option('profile_holiday_hosoku') ) ;?>
				</td>
				</tr>
				<?php endif; ?>
				</table>
			...
			<section id="enkaku">
			<div class="slide-table">
			<?php echo wpautop( post_custom ('about-enkaku')) ;?>
			</div>
			</section><!--enkaku-->
			<?php endif;?>
			...
			<section class="gaiyou anchor" id="map">
				<h2>アクセスマップ</h2>
				<div class="profile_googlemap-access">
				<?php echo wpautop(get_option('profile_googlemap-access')); ?>
				</div>
				...
				<div class="profile_googlemap-access02" style="margin-top:2em;">
				<?php echo wpautop(get_option('profile_googlemap-access02')); ?>
				</div>

				<div class="profile_googlemap movie-wrap">
				<?php echo get_option('profile_googlemap2') ; ?>
				</div>
