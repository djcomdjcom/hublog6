...
?>
	...
	<div id="container" class="widecolumn single clearfix bukken">
		
		<div id="content" role="main" <?php post_class(join(' ',(array)$content_class)); ?>>
			...
			<div id="post-title" class="clearfix" >
				...
				<span class="back-to-index"><?php echo $linkback_category; ?></span>
			</div><!-- #post-title -->
			...
			<span class="date">掲載日：<?php the_time('Y 年 n 月 j 日')  ?><?php edit_post_link(__('Edit'), ' (', ')'); ?></span>				
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(join(' ',(array)$content_class)); ?>>
				...
				<section id="single-left">
					...
					</div><!--spec_excerpt-box-->
						
						<?php get_template_part('hublog-spec-detail', $in_cat); //物件詳細 ?>
						
						<div id="spec_excerpt-btn" class="clearfix">
							<?php if ( post_custom('hanbaizumen') ) : ?>
							<div id="btn-spec-pdf"><a href="<?php echo esc_url(post_custom('hanbaizumen')); ?>">販売図面</a></div><!--btn-spec-pdf-->
							<? endif ;?>
							
							<div id="btn-spec-print"><a href="#" onClick="window.print();return false">この物件の概要を印刷</a></div><!--btn-spec-print-->
						
						</div><!--spec_excerpt-btn-->
				...
				<section id="single-right" class="clearfix">
					...
					if ( count( $images_zumen ) ) : ?>
						...
						<div id="plans" class="clearfix">
							...
							<div class="pickup-image pickup-image-<?php echo ++$c_pickupimg; ?> pickup-image-id-<?php echo $key; ?>">
								<span class="title"><?php echo $value; ?></span>
								<a rel="lightbox[pickup]" href="<?php echo wp_get_attachment_url($key); ?>" ><?php echo wp_get_attachment_image($key,'medium') ?></a>
							</div>
					...
					<?php get_template_part('googlemaps', 'bukken'); ?>
							...
							<div id="loan-sample">
								...
								<div id="loan-sample-main" class="cleartype">
									<span class="loan-pay-month">
									
									<span class="number cleartype">月々<strong><?php echo post_custom_cft('loan-pay-month') ; ?></strong>のお支払い</span>　
									</span>
								</div><!--loan-sample-main-->
								
								<div id="loan-sample-sub">
									<span class="loan-atamakin">
									頭金：<?php echo post_custom_cft('loan-deposit') ; ?>
									</span>
									&nbsp;&nbsp;
									<span class="loan-kariire">
									借入れ：<strong><?php echo post_custom_cft('loan-kariire') ; ?></strong>
									</span>
									
									
									<p class="loan-atamakin">
									（金利：<strong><?php echo post_custom_cft('loan-kinri') ; ?></strong>
									<span class="loan-period">&nbsp;&nbsp;<?php echo post_custom_cft('loan-period') ; ?>返済の場合）</span>
									</p>
									
									<?php if ( post_custom('loan-caution') ) : ?>
									<p class="loan-caution">
									※&nbsp;<?php echo post_custom('loan-caution') ; ?>
									</p>
									<?php endif; ?>
								</div><!--loan-sample-sub-->
							</div><!--loan-sample-->
					...
					<span class="back-to-index single-bottom">
					<?php echo $linkback_category; ?>
					</span>
