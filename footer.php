...
<nav id="global-navi" class="pt-3">
  <div class="global-navi-inner container">
    <div id="global-navi-logo" class="wrapper mb-0 mb-md-4 px-2 pb-3"> <a class="w100 maxw-600 px-5 mx-0 mx-auto" href="/"><?php echo get_option('profile_shop_name'); ?></a> </div>
        <?php
    ...
    <div class="inc_contact-btn">
      <ul class="row justify-content-around px-0 mx-auto container">
...
<div onClick="accordion" style="right: 0;bottom: 80px;z-index: 999999;background:  rgba(255,255,255,0.79)" class="position-fixed">
  <div class="option">
    <input type="checkbox" id="hint001" class="toggle">
    <label class="title" for="hint001"></label>
    <div class="content" >
