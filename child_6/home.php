...
<article id="container">
  ...
  <!--▼▼▼コンセプト▼▼▼-->
  <section id="home-concept" class="py-5 px-3 px-xl-0">
...
<p class="txt-ll mb-5">
リフォーム工事から<br class="d-sm-none">新築注文住宅まで<br>
...
健康志向の家</h3>
			...
			<span class="todetail"><a href="/concept#page_concept01" title="コンセプト「住んで健康になれる」"></a></span>
          </li>
          <li class="choice02 col-6 col-md-3 mb-4 linkarea">
			...
			<span class="todetail"><a href="/concept#page_concept02" title="コンセプト「自社職人と自社施工」"></a></span>
          </li>
...
断熱効果の高い家</h3>
			...
			<span class="todetail"><a href="/concept#page_concept03" title="コンセプト「耐震性・耐久性断熱効果の高い家」"></a></span>
          </li>
          <li class="choice04 col-6 col-md-3 mb-4 linkarea">
			...
			<span class="todetail"><a href="/concept#page_concept04" title="コンセプト「ゼロエネルギースタイル」"></a></span>
          </li>
        </ul>
      </div>
  ...
  <!--▼▼▼インフォエリア▼▼▼-->
  <div id="home-infoarea" class="row wrapper container mx-auto px-0 mb-5 ">
    <section id="home-news" class="home-content col-md-6 mb-5 align-self-stretch">
      <header class="content_header text-center">
        <h2 class="ttl ">ニュース＆トピックス</h2>
        <div class="arrow"><a href="/category/news" title="ニュース＆トピックス一覧ページヘのリンク">一覧へ</a> </div>
      </header>
      <?php
      $args = array(
        'post_type' => 'post',
    ...
    <!--home-news-->
    <section id="home-event" class="home-content col-md-6 mb-5 align-self-stretch">
      <header class="content_header text-center">
        <h2 class="ttl ">近日イベントのご案内</h2>
        <div class="arrow"> <a href="/category/event" title="イベント情報">一覧へ</a> </div>
      </header>
      <?php
      $args = array(
        'post_type' => 'post',
...
$('.posts .post.style-event .thumbnail').addClass('py-0 pr-sm-4'); 
});		
</script>
      <div class="posts container mx-auto">
        <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
  ...
  <section id="home-greeting" class="pb-4 mb-5">
    <div class="wrapper container">
      ...
      <!--▼▼▼代表あいさつ▼▼▼-->
      <figure id="president"> <a href="/message" class="w100"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/hm-bnr-president@2x.jpg" alt="代表あいさつ"/></a> </figure>
  ...
  <section id="home-blog" class="pt-5 pb-5 mb-5 ">
...
$('#home-blog .posts .post').addClass('p-3 col-md-3 col-sm-6 col-12'); 
    ...
    <header class="content_header text-center">
      ...
      <h2 class="ttl ">ブログ</h2>
          ...
          <div class="aboveright arrow toindex"> <a href="/category/blog">一覧へ</a></div>
          <?php wp_reset_query(); ?>
      </div>
  </section>
  <section id="hajimetenavi" class="navi text-center mt-5 mb-5">
    <header class="content_header wrapper container mb-4">
      <h2 class="ttl ">お客様の状況に応じて
		  <span class="text-nowrap">アクションをお選びください</span></h2>
    </header>
    <div class="wrapper container">
