<div class="snslink wrapper">
  <ul class="flexbox justify-content-around">
    ...
    <li class=""> <a target="_blank" class="w100" href="<?php echo get_option('profile_sns_tw'); ?>">
      <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
        <title><?php echo get_option('profile_corporate_name'); ?>のtwitter</title>
        <g id="snsicon-tw" transform="translate(-911 -2899)">
          <path id="パス_8235" data-name="パス 8235" d="M88.517,40.315a27.5,27.5,0,0,1-14.874-4.361,23.057,23.057,0,0,0,2.329.126A19.6,19.6,0,0,0,88,31.928a9.671,9.671,0,0,1-9.063-6.73,10.743,10.743,0,0,0,1.842.166,9.647,9.647,0,0,0,2.542-.341A9.723,9.723,0,0,1,75.541,15.4a9.827,9.827,0,0,0,4.4,1.207A9.7,9.7,0,0,1,76.933,3.654a27.668,27.668,0,0,0,20,10.133,9.7,9.7,0,0,1,9.449-11.91,9.752,9.752,0,0,1,7.086,3.064,19.483,19.483,0,0,0,6.15-2.356,9.629,9.629,0,0,1-4.256,5.378,19.868,19.868,0,0,0,5.564-1.54,19.316,19.316,0,0,1-4.832,5.035,28.592,28.592,0,0,1-7.8,20.646,26.589,26.589,0,0,1-19.774,8.21" transform="translate(845.504 2906.775)" fill="#595757"/>
        </g>
      </svg>
      </a> </li>
    <?php endif;?>
    ...
    <li class=""> <a target="_blank" class="w100" href="<?php echo get_option('profile_sns_fb'); ?>">
      <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
        ...
        <g id="snsicon-fb" transform="translate(-1135 -2899)">
          <path id="パス_8233" data-name="パス 8233" d="M186.661,47.491h9.562V23.544H202.9l.712-8.018h-7.385V10.959c0-1.889.382-2.638,2.209-2.638h5.175V0h-6.621c-7.116,0-10.325,3.135-10.325,9.133v6.393h-4.975v8.118h4.975Z" transform="translate(972.855 2904.648)" fill="#595757"/>
        </g>
      </svg>
      </a> </li>
    <?php endif;?>
